...
try:
    from geonode_geografia.local_settings import *
except ImportError:
    from geonode_geografia.settings import *
...
def _reset():
    ...
    sh("rm -rf geonode_geografia/development.db")
    sh("rm -rf geonode_geografia/uploaded/*")
    _install_data_dir()
